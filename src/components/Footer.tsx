    ...
    <footer className="site-footer" id="contact">
      ...
      <div className="container footer-main">
        ...
        <div className="footer-brand">
          ...
          <p className="footer-tagline">All Roads Lead Home.</p>
          <p className="footer-mini-copy">Premium weekend car detailing across the UK.</p>
          <p className="footer-mini-copy small">Correction &bull; Protection &bull; Reflection</p>
        </div>
      ...
      <div className="container footer-bottom">
        <p>&copy; {new Date().getFullYear()} M.H Detailz. All Rights Reserved.</p>
